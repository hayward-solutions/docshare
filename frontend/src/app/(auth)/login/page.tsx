    ...
    <>
      <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      id="ldap-username"
                      type="text"
                      placeholder="domain\\username or cn=user,dc=example,dc=com"
                      required
                      value={ldapUsername}
        ...
        <CardFooter className="flex flex-col space-y-4">
          <Button 
            type="submit" 
            form={hasLdap && ldapUsername ? undefined : 'email'} 
            className="w-full" 
            disabled={isLoading}
            onClick={hasLdap && ldapUsername ? handleLdapSubmit : undefined}
          >
